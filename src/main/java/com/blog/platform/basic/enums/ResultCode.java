...
public enum ResultCode {
    ...
    USER_ACCOUNT_DISABLE("A0202", "用户账户已禁用"),
    ...
    BIZ_SYSTEM_PERMISSION_ERROR("B0200", "权限异常"),
    BIZ_SYSTEM_PERMISSION_NAME_HAS_EXIST("B0201", "权限名称已存在"),
    BIZ_SYSTEM_PERMISSION_PARENT_NOT_EXIST("B0202", "父级权限不存在"),
    BIZ_SYSTEM_PERMISSION_NOT_EXIST("B0203", "本权限不存在"),
    BIZ_SYSTEM_PERMISSION_HAS_CHILD("B0204", "存在子级权限，不允许删除"),
    BIZ_SYSTEM_PERMISSION_HAS_DISTRIBUTE("B0205", "权限已被分配，不允许删除"),

    BIZ_SYSTEM_ROLE_ERROR("B0300", "角色异常"),
    BIZ_SYSTEM_ROLE_NAME_HAS_EXIST("B0301", "角色名称已存在"),
    BIZ_SYSTEM_ROLE_NOT_EXIST("B0302", "本角色不存在"),
    BIZ_SYSTEM_ROLE_HAS_DISTRIBUTE("B0304", "角色已被分配，不允许删除"),
    ...
    BIZ_SYSTEM_LABEL_PARENT_NOT_EXIST("B0502", "父级标签不存在"),
    BIZ_SYSTEM_LABEL_NOT_EXIST("B0503", "本标签不存在"),
    BIZ_SYSTEM_LABEL_HAS_CHILD("B0504", "存在子级标签，不允许删除"),
    BIZ_SYSTEM_LABEL_DISTRIBUTE("B0505", "标签已被分配，不允许删除"),
